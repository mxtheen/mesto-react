...
function App() {
  ...
  return (
    <>
      ...
      ></Main>
      <Footer></Footer>
      <PopupWithForm name='edit' title='Редактировать профиль' isOpen = {isEditProfilePopupOpen} onClose={closeAllPopups} buttonContent="Сохранить"
      children={
        <>
      ...
      <PopupWithForm name='update-avatar' title='Обновить аватар' isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups} buttonContent="Сохранить"
       children={
        <>
